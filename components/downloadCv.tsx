    ...
    >
      <div>
        ...
        <div className="flex justify-center">
          <a href="/Mohamed-Ibrahim-Full-Stack-Software-Developer-Resume.pdf" download className="bg-cyan-400 text-neutral-950 px-4 py-2 rounded-lg shadow-md hover:bg-cyan-600 transition duration-300">
            Download CV
          </a>
        </div>
      </div>
